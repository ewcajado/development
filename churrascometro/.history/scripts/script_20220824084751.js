...
function calcular(){
    ...
    resultado.innerHTML += `<p>${qtdTotalLinguica / 1000} kg of salsage</p>`
    resultado.innerHTML += `<p>${Math.ceilqtdAlho / 100} kg of garlic bread</p>`
    resultado.innerHTML += `<p>${Math.ceil(qtdTotalCerveja / 355)} beer cans</p>`
    resultado.innerHTML += `<p>${Math.ceil(qtdTotalBebidas / 2000)} juice or soda botlles</p><br>let go to the barbecue party!`
