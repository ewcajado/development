...
function createCardFace (face, card, element) {
     ...
     if (face === FRONT){
          ...
          iconTElement.classList.add(backIcon);
          iconTElement.src = "./assets/images/back/" + card.icon + ".png";
...
function createWorldCupCards(worldCup){
     return backCards = [];

     worldCup.forEach(backCards, function
}
