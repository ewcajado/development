...
function calculate() {
    ...
    result.innerHTML = `<p>${meatAmount / 1000} kg of meat.</p>`
    result.innerHTML += `<p>${Math.ceil(beerAmount / 355)} beer cans.</p>`
    result.innerHTML += `<p>${Math.ceil(drinkAmount / 2000)} juice or soda bottles.</p><br>Enjoy the Barbecue Moment!`
